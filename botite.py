...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE) -> int:
    ...
    id = str (context._user_id)
    cursor.execute(f"INSERT INTO registered_users VALUES ({id})")
    await update.message.reply_text(
        "Hola! Soy el ITEbot. Fui creado con el proposito de ayudarte a responder tus preguntas, ayudarte a conocer tu escuela y tu carrera asi como otras funciones extras. "
